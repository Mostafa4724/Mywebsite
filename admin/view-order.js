(function () {
  ...
  // Product data loaded directly from the products table API.
  // This is the same source used by home.html.
  var productsById = {};
  ...
  async function loadProductsForOrder() {
    ...
    try {
      ...
      // The order endpoint still supplies item.image as a fallback.
      console.warn(
  ...
  async function loadOrder() {
    ...
    try {
      ...
      // Load the current products from shopping.db before rendering
      // the Order Items images.
